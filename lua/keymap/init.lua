...
local plug_map = {
	...
	["n|lg"] = map_cmd("<cmd>echo expand('%:p')<CR>"):with_noremap():with_silent(),
	["n|ln"] = map_cr("Lspsaga diagnostic_jump_next"):with_noremap():with_silent(),
	["n|lp"] = map_cr("Lspsaga diagnostic_jump_prev"):with_noremap():with_silent(),
	["n|ls"] = map_cr("Lspsaga signature_help"):with_noremap():with_silent(),
	["n|lrn"] = map_cr("Lspsaga rename"):with_noremap():with_silent(),
	["n|lh"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),
	...
	["n|lca"] = map_cr("Lspsaga code_action"):with_noremap():with_silent(),
	["v|lra"] = map_cu("Lspsaga range_code_action"):with_noremap():with_silent(),
	["n|gpd"] = map_cr("Lspsaga preview_definition"):with_noremap():with_silent(),
	-- ["n|gd"] = map_cr("lua vim.lsp.buf.definition()"):with_noremap():with_silent(),
	["n|gd"] = map_cr("Lspsaga peek_definition"):with_noremap():with_silent(),
	["n|gc"] = map_cmd("<cmd>lua vim.lsp.buf.declaration()<CR>"):with_noremap():with_silent(),
	...
	["n|gs"] = map_cmd("<cmd>lua vim.lsp.buf.document_symbol()<CR>"):with_noremap():with_silent(),
	["n|gws"] = map_cmd("<cmd>lua vim.lsp.buf.workspace_symbol()<CR>"):with_noremap():with_silent(),
	["n|gn"] = map_cmd("<cmd>lua vim.lsp.buf.diagnostic_jump_next()<CR>"):with_noremap():with_silent(),
	["n|gp"] = map_cmd("<cmd>lua vim.lsp.buf.diagnostic_jump_prev()<CR>"):with_noremap():with_silent(),
	["n|gh"] = map_cr("<cmd>lua vim.lsp.buf.hover()<CR>"):with_noremap():with_silent(),
